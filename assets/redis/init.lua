...
redis.call('HMSET', 'prop::groupType::baiyin', 'total_players', 4, 'total_visitors', 0, 'min_run', 1, 'capacity', 200);
redis.call('HMSET', 'prop::groupType::huangjin', 'total_players', 4, 'total_visitors', 0, 'min_run', 1, 'capacity', 300);
