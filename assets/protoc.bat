...
protoc.exe --java_out=..\gws-protobuf-chat\src\main\java\ .\protobuf\method.chat.send.proto .\protobuf\model.chat.proto
protoc.exe --js_out=library=..\front\assets\js\emag\chat,binary:. .\protobuf\method.chat.send.proto .\protobuf\model.chat.proto
